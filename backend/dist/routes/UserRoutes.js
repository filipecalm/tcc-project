...
routes.get('/:id', verify_token_1.default, verify_admin_1.default, UserController_1.default.getOne);
routes.post('/', create_1.default, UserController_1.default.register);
routes.patch('/:id', verify_token_1.default, UserController_1.default.updatedUser);
